			...
			<BrowserRouter>
				...
				<div className="pages">
					<Routes>
						...
						<Route path="/users/:userId/decks/:deckId/cards/reviewcards" element={<Review />} />
						<Route path="/users/:userId/decks/:deckId/cards/practicecards" element={<Practice />} />
						<Route path="/users/:userId/profile" element={<Profile />} />
						<Route path="/users/:userId/decks/decklist" element={<Home2 />} />
						<Route path="/users/:userId/decks/:deckId/delete" element={<DeleteDeck />} />
						<Route path="/users/:userId/decks/:deckId/edit" element={<EditDeck />} />
